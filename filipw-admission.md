...
A linear regression where we model *y* (district heating consumption) as
a result of *x* (temperature) is defined as line with an intercept
*β*<sub>0</sub>, the coefficient *β*<sub>1</sub> which tells us how
steep the slope is. Lastly we have the error term, which is all the
variation that our coefficients cannot explain.
*c**o**n**s**u**m**p**t**i**o**n* = *β*<sub>0</sub> + *β*<sub>1</sub> \* *t**e**m**p**e**r**a**t**u**r**e* + *ϵ*
The K2 algorithm can be defined as a linear regression with a separate
coefficient for each temperature interval.

*c**o**n**s**u**m**p**t**i**o**n* = *β*<sub>1</sub> \* *t**e**m**p*<sub>1</sub> + *β*<sub>2</sub> \* *t**e**m**p*<sub>2</sub> + *β*<sub>3</sub> \* *t**e**m**p*<sub>3</sub> + *β*<sub>4</sub> \* *t**e**m**p*<sub>4</sub> + *ϵ*

A generalized additive model takes a different approach and defines the
relationship as a *function* of temperature:

*c**o**n**s**u**m**p**t**i**o**n* = *f*(*x*) + *ϵ*
...
<p class="caption">
Source:
<a href="https://github.com/noamross/gam-resources/blob/master/2017-11-14-noamross-gams-nyhackr.pdf" class="uri">https://github.com/noamross/gam-resources/blob/master/2017-11-14-noamross-gams-nyhackr.pdf</a>
</p>
...
![](filipw-admission_files/figure-markdown_strict/plot_temp-1.png)
...
![](filipw-admission_files/figure-markdown_strict/plot_gam-1.png)
...
![](filipw-admission_files/figure-markdown_strict/model_diag_1-1.png)
...
![](filipw-admission_files/figure-markdown_strict/resid_time-1.png)
...
today’s consumption is not independent to yesterday’s. That makes sense
intuitively but independence is usually an assumption many models have.
...
![](filipw-admission_files/figure-markdown_strict/pacf-1.png)
...
![](filipw-admission_files/figure-markdown_strict/corrplot-1.png)
...
![](filipw-admission_files/figure-markdown_strict/season-1.png)
...
![](filipw-admission_files/figure-markdown_strict/weekday-1.png) These
...
![](filipw-admission_files/figure-markdown_strict/model_diag_all_vars-1.png)
...
![](filipw-admission_files/figure-markdown_strict/unnamed-chunk-1-1.png)
...
![](filipw-admission_files/figure-markdown_strict/plot_fit-1.png)
